...
var dao = require('car-service-bookings/data/dao/Bookings/BookingMechanics');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('BookingMechanics not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/car-service-bookings/api/BookingMechanics.js/' + entity.Id);
