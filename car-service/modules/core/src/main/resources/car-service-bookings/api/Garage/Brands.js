...
var dao = require('car-service-bookings/data/dao/Garage/Brands');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Brands not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/car-service-bookings/api/Brands.js/' + entity.Id);
