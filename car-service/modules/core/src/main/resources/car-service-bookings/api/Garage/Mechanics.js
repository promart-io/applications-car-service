...
var dao = require('car-service-bookings/data/dao/Garage/Mechanics');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Mechanics not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/car-service-bookings/api/Mechanics.js/' + entity.Id);
