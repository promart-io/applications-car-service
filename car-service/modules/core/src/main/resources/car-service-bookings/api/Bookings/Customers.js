...
var dao = require('car-service-bookings/data/dao/Bookings/Customers');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Customers not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/car-service-bookings/api/Customers.js/' + entity.Id);
