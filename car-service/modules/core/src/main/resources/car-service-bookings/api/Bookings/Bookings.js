...
var dao = require('car-service-bookings/data/dao/Bookings/Bookings');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Bookings not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/car-service-bookings/api/Bookings.js/' + entity.Id);
